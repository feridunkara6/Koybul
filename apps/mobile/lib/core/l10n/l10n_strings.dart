...
class L10n {
  const L10n({
    ...
    required this.tripPlanBtn,
    required this.tripPlannedShort,
    required this.tripPlannedSnack,
    required this.tripPlannedBadge,
    required this.tripMarkDone,
    required this.tripDoneSheetTitle,
    required this.dateToday,
    required this.dateYesterday,
    required this.datePickLabel,
    required this.tripDurQ,
    required this.dur2h,
    required this.durHalf,
    required this.durFull,
    required this.tripNoteHint,
    required this.tripDoneSave,
    required this.tripDoneSnack,
    ...
    required this.routeDistCap,
    required this.routeEtaCap,
    required this.routeOriginSnapped,
    ...
    required this.admRow,
    required this.admTitle,
    required this.admLead,
    required this.admUsers,
    required this.admGuests,
    required this.admNew7d,
    required this.admPremium,
    required this.admPending,
    required this.admReviews,
    required this.admNotes,
    required this.admGrantTitle,
    required this.admGrantHint,
    required this.admEmailLabel,
    required this.admMonthsFmt,
    required this.admGrantBtn,
    ...
    required this.premRow,
    required this.premTitle,
    required this.premLead,
    required this.premFeatDetail,
    required this.premFeatRoutes,
    required this.premFeatSaves,
    required this.premFeatBoat,
    required this.premYearly,
    required this.premMonthly,
    required this.premYearlyTag,
    required this.premPerMonthFmt,
    required this.premBuy,
    required this.premRestore,
    required this.premRestoreDone,
    required this.premActive,
    required this.premUntilFmt,
    required this.premNeedAccount,
    required this.premSignInBtn,
    required this.premWebMsg,
    required this.premUnavailable,
    required this.premPurchaseError,
    required this.premLinking,
    required this.premDone,
    required this.premCancelNote,
    required this.detPhotoBadgeFmt,
    required this.detLockTitle,
    required this.detLockBody,
    required this.detLockCta,
    required this.detUnlockFmt,
    required this.detUnlockedFmt,
    required this.detUnlockNone,
    required this.detLockSignIn,
    required this.rqTitle,
    required this.rqBody,
    required this.rqSavedNote,
    required this.rqPremiumBtn,
    required this.rqWaitBtn,
    required this.rqUsedFmt,
    required this.msTitle,
    required this.msBody,
    required this.rsSlotsTitle,
    required this.rsSlotsBody,
    ...
    required this.srcTitle,
    required this.srcLead,
    required this.srcMapTitle,
    required this.srcMapBody,
    required this.srcWeatherTitle,
    required this.srcWeatherBody,
    required this.srcDataTitle,
    required this.srcDataBody,
    required this.srcPhotosTitle,
    required this.srcPhotosLeadFmt,
    ...
    required this.routePlanFromMeSub,
    required this.routePlanTwoPoints,
    required this.routePlanTwoPointsSub,
    ...
    required this.routeAddToSaved,
    required this.routeMoreTooltip,
  ...
  final String navToday, navDeck, navBoat, deckTabRoutes, deckTabNotes,
      todayNoPos;
  // SEYİR v2.1 "Planla → Gerçekleşti" (kurucu onayı 2026-08): başlat/bitir
  // anahtarları kaldırıldı — kod hiçbir yerde kullanmıyor (analiz temiz).
  final String deckTabTrips, tripPlanBtn, tripPlannedShort, tripPlannedSnack,
      tripPlannedBadge, tripMarkDone, tripDoneSheetTitle, dateToday,
      dateYesterday, datePickLabel, tripDurQ, dur2h, durHalf, durFull,
      tripNoteHint, tripDoneSave, tripDoneSnack, tripsEmpty,
  ...
  final String routeDistCap, routeEtaCap, routeOriginSnapped;
  ...
  final String admRow, admTitle, admLead, admUsers, admGuests, admNew7d, admPremium;
  ...
  // --- Koybul Premium (P3, kurucu onayı 2026-09-21): paket ekranı + profil satırı.
  // Fiyat metni BURADA YOKTUR — fiyatı her zaman mağaza söyler (tahmin yok).
  final String premRow, premTitle, premLead;
  final String premFeatDetail, premFeatRoutes, premFeatSaves, premFeatBoat;
  final String premYearly, premMonthly, premYearlyTag, premPerMonthFmt;
  final String premBuy, premRestore, premRestoreDone;
  final String premActive, premUntilFmt;
  final String premNeedAccount, premSignInBtn, premWebMsg, premUnavailable;
  final String premPurchaseError, premLinking, premDone, premCancelNote;

  // --- Kilitli koy detayı / keşif hakkı (P4, kurucu onayı 2026-09-22) ---
  final String detPhotoBadgeFmt, detLockTitle, detLockBody, detLockCta;
  final String detUnlockFmt, detUnlockedFmt, detUnlockNone, detLockSignIn;

  // --- Rota kotası / çok durak / kayıt yuvaları (P4b, kurucu onayı 2026-09-22) ---
  final String rqTitle, rqBody, rqSavedNote, rqPremiumBtn, rqWaitBtn, rqUsedFmt;
  final String msTitle, msBody, rsSlotsTitle, rsSlotsBody;
  ...
  // Kaynaklar ve Lisanslar ekranı (FAZ 0 K4, 2026-09): harita/hava/veri/
  // fotoğraf atıflarının tek vitrini.
  final String srcRow, srcTitle, srcLead, srcMapTitle, srcMapBody,
      srcWeatherTitle, srcWeatherBody, srcDataTitle, srcDataBody,
      srcPhotosTitle, srcPhotosLeadFmt;
  ...
  final String cancelLabel, saveLabel, routeFromDeviceOpt, routePickOriginOpt,
      routePlanFromMeSub, routePlanTwoPoints, routePlanTwoPointsSub,
      ...
      routeAddToSaved, routeMoreTooltip,
...
const L10n _tr = L10n(
  ...
  tripPlanBtn: 'Seyri planla',
  tripPlannedShort: 'Defter\'e eklendi ✓',
  tripPlannedSnack: 'Sefer, Defter\'e PLANLANDI olarak eklendi — yaptığında Gerçekleşti\'yi işaretle.',
  tripPlannedBadge: 'PLANLANDI',
  tripMarkDone: 'Gerçekleşti ✓',
  tripDoneSheetTitle: 'Seferi deftere işle',
  dateToday: 'Bugün',
  dateYesterday: 'Dün',
  datePickLabel: 'Tarih seç',
  tripDurQ: 'Denizde ne kadar kaldın? (isteğe bağlı)',
  dur2h: '~2 sa',
  durHalf: 'Yarım gün',
  durFull: 'Tam gün',
  tripNoteHint: 'Bir not düş… (isteğe bağlı, Kaptanın Günlüğü\'ne gider)',
  tripDoneSave: 'Deftere işle',
  tripDoneSnack: 'Sefer GERÇEKLEŞTİ olarak deftere işlendi.',
  tripsEmpty: 'Henüz sefer yok. Haritada bir rota çiz ve "Seyri planla"ya dokun — plan buraya düşer; seferi yaptığında Gerçekleşti\'yi işaretle.',
  ...
  routeDistCap: 'MESAFE',
  routeEtaCap: 'SÜRE',
  routeOriginSnapped: 'Başlangıç kıyıya taşındı — konumun karadaydı',
  ...
  admRow: 'Yönetim Paneli',
  admTitle: 'Yönetim Paneli',
  admLead: 'Sayılar sunucudan canlı gelir; yalnız yönetici hesaplar görebilir.',
  admUsers: 'Kayıtlı kullanıcı',
  admGuests: 'Misafir oturum',
  admNew7d: 'Yeni kayıt (7 gün)',
  admPremium: 'Aktif Premium',
  admPending: 'Bekleyen onay',
  admReviews: 'Toplam yorum',
  admNotes: 'Kaptan notu',
  admGrantTitle: 'Premium tanımla',
  admGrantHint: 'Kayıtlı kullanıcının e-postasını yaz, süreyi seç — hesabı anında Premium olur.',
  admEmailLabel: 'Kullanıcı e-postası',
  admMonthsFmt: '{0} ay',
  admGrantBtn: 'Premium tanımla',
  ...
  dayUnit: 'gün',
  premRow: 'Koybul Premium',
  premTitle: 'Koybul Premium',
  premLead: 'Koyların tüm bilgileri, sınırsız rota ve daha fazlası — denize seninle gelen tek abonelik.',
  premFeatDetail: 'Koyların tüm bilgileri: fotoğraflar, doluluk, yaklaşma notları, saatlik rüzgâr',
  premFeatRoutes: 'Sınırsız rota + çok duraklı rota çizimi',
  premFeatSaves: 'Sınırsız rota kaydı',
  premFeatBoat: 'Tekne profili ve koya uygunluk kontrolü',
  premYearly: 'Yıllık',
  premMonthly: 'Aylık',
  premYearlyTag: 'Avantajlı seçim',
  premPerMonthFmt: 'Aylık karşılığı yaklaşık {0}',
  premBuy: 'Premium\'a geç',
  premRestore: 'Satın alımları geri yükle',
  premRestoreDone: 'Mağaza kontrol edildi — bu Apple hesabında aktif yeni bir abonelik bulunamadı.',
  premActive: 'Premium etkin',
  premUntilFmt: 'Yenileme/bitiş: {0}',
  premNeedAccount: 'Premium, Koybul hesabına bağlanır — böylece aboneliğin telefon değişse de seninle gelir. Önce ücretsiz bir hesap aç ya da giriş yap.',
  premSignInBtn: 'Giriş yap / hesap aç',
  premWebMsg: 'Premium aboneliği Koybul iOS uygulamasından başlatılır; web sürümünde satın alma yoktur. Aboneliğin, aynı hesapla girince her yerde geçerlidir.',
  premUnavailable: 'Mağazaya şu an ulaşılamıyor. Bağlantını kontrol edip biraz sonra tekrar dene.',
  premPurchaseError: 'İşlem tamamlanamadı. Paran çekilmediyse tekrar deneyebilirsin; sorun sürerse App Store hesabını kontrol et.',
  premLinking: 'Aboneliğin doğrulanıyor…',
  premDone: 'Premium etkinleşti — iyi seyirler, kaptan!',
  premCancelNote: 'Abonelik dönem sonunda kendiliğinden yenilenir; App Store hesabından istediğin an tek dokunuşla iptal edebilirsin. Premium bitse bile kayıtların silinmez.',
  detPhotoBadgeFmt: '1/{0} · kalanı Premium\'da',
  detLockTitle: 'Koyun tamamı Premium\'da',
  detLockBody: 'Fotoğraflar, doluluk, yaklaşma notları, saatlik rüzgâr, iletişim ve kaptan notları — hepsi Koybul Premium ile.',
  detLockCta: 'Premium\'u tanı',
  detUnlockFmt: 'Keşif hakkınla aç ({0} kaldı)',
  detUnlockedFmt: 'Koy açıldı — bu ay {0} keşif hakkın kaldı.',
  detUnlockNone: 'Bu ayın keşif hakları bitti — gelecek ay 3 yeni hak. Sınırsızı Premium açar.',
  detLockSignIn: 'Üye ol — her ay 3 koyu ücretsiz açma hakkı',
  rqTitle: 'Bugünün rotaları doldu (3/3)',
  rqBody: 'Ücretsiz kullanımda günde 3 yeni rota çizilir. Sayaç gece yarısı sıfırlanır — yarın 3 yeni hakkın hazır.',
  rqSavedNote: 'Kayıtlı rotalarını açmak ve mevcut rotayı düzenlemek hak yemez.',
  rqPremiumBtn: 'Sınırsız rota — Premium\'u tanı',
  rqWaitBtn: 'Yarını beklerim',
  rqUsedFmt: 'Bugün {0}/{1} rota kullandın',
  msTitle: 'Çok duraklı rota Premium\'da',
  msBody: 'Ücretsiz rotada tek varış noktası var. Birden çok koyu tek seyirde birleştirmek (A→B→C) Koybul Premium ile açılır. Mevcut rotan olduğu gibi duruyor.',
  rsSlotsTitle: 'Kayıt yuvaların doldu (3/3)',
  rsSlotsBody: 'Ücretsiz kullanımda 3 rota kaydedilebilir. Yenisine yer açmak için bir kaydı sil ya da sınırsız kayıt için Premium\'a geç.',
  ...
  seaRouteFrom: 'Konumundan · kuşuçuşu',
  hourUnit: 'sa',
  minUnit: 'dk',
  ...
  srcRow: 'Kaynaklar ve lisanslar',
  srcTitle: 'Kaynaklar ve Lisanslar',
  srcLead: 'Bu uygulamadaki harita, hava ve fotoğraf içerikleri aşağıdaki kaynaklardan gelir. Atıflar burada tek yerde toplanır; liste çevrimdışı da okunur.',
  srcMapTitle: 'Harita',
  srcMapBody: 'Harita altlığı: Powered by Esri. Deniz işaretleri: OpenSeaMap. Harita verileri: © OpenStreetMap katkıcıları. Atıf, harita köşesinde de her zaman görünür.',
  srcWeatherTitle: 'Hava durumu',
  srcWeatherBody: 'Rüzgâr ve hava verileri MET Norway (met.no) tahminleridir; atıf ve saat bilgisi her tahmin kartında da gösterilir. Tahminler seyir yayını değildir.',
  srcDataTitle: 'Koy ve liman bilgileri',
  srcDataBody: 'Her kaydın açıklaması kaynak alıntısıyla birlikte saklanır ve detay sayfasında gösterilir; tahmin ya da uydurma bilgi girilmez. Göcek tonoz doluluğu ve bazı fotoğraflar DERİA (Türkiye Çevre Ajansı) kaynaklıdır.',
  srcPhotosTitle: 'Fotoğraflar',
  srcPhotosLeadFmt: 'Uygulamadaki {0} kapak fotoğrafının atıf listesi. Bir satıra dokununca fotoğrafın kaynak sayfası açılır; atıf ayrıca fotoğrafın üzerinde de görünür.',
  ...
  routePlanFromMeSub: 'Hedef koyu seç — rota, paylaştığın konumdan çizilir.',
  routePlanTwoPoints: 'İki nokta arası (A → B)',
  routePlanTwoPointsSub: 'Önce hedefi seç, sonra başlangıcı haritadan ya da bir koydan işaretle. Konum izni gerekmez.',
  ...
  routeAddToSaved: 'Rotalarım\'a ekle',
  routeMoreTooltip: 'Diğer seçenekler',
  routeSaved: 'Rota, Rotalarım\'a eklendi — Defter → Rotalarım.',
...
const L10n _en = L10n(
  ...
  tripPlanBtn: 'Plan voyage',
  tripPlannedShort: 'Added to Deck log ✓',
  tripPlannedSnack: 'Voyage added to your Deck log as PLANNED — mark it Done once you sail it.',
  tripPlannedBadge: 'PLANNED',
  tripMarkDone: 'Done ✓',
  tripDoneSheetTitle: 'Log this voyage',
  dateToday: 'Today',
  dateYesterday: 'Yesterday',
  datePickLabel: 'Pick a date',
  tripDurQ: 'How long were you at sea? (optional)',
  dur2h: '~2 h',
  durHalf: 'Half day',
  durFull: 'Full day',
  tripNoteHint: 'Add a note… (optional, goes to the Captain\'s Log)',
  tripDoneSave: 'Log it',
  tripDoneSnack: 'Voyage logged as DONE.',
  tripsEmpty: 'No voyages yet. Draw a route on the map and tap "Plan voyage" — the plan lands here; mark it Done once you sail it.',
  ...
  todayWindCap: 'WIND',
  routeDistCap: 'DISTANCE',
  routeEtaCap: 'TIME',
  routeOriginSnapped: 'Start moved to the shore — your location was on land',
  ...
  admRow: 'Admin Panel',
  admTitle: 'Admin Panel',
  admLead: 'Figures come live from the server; only admin accounts can see this.',
  admUsers: 'Registered users',
  admGuests: 'Guest sessions',
  admNew7d: 'New sign-ups (7 days)',
  admPremium: 'Active Premium',
  admPending: 'Pending approval',
  admReviews: 'Total reviews',
  admNotes: 'Captain notes',
  admGrantTitle: 'Grant Premium',
  admGrantHint: 'Enter a registered user\'s email and pick a duration — the account becomes Premium instantly.',
  admEmailLabel: 'User email',
  admMonthsFmt: '{0} months',
  admGrantBtn: 'Grant Premium',
  ...
  premRow: 'Koybul Premium',
  premTitle: 'Koybul Premium',
  premLead: 'Full bay details, unlimited routes and more — one subscription that sails with you.',
  premFeatDetail: 'Full bay details: photos, occupancy, approach notes, hourly wind',
  premFeatRoutes: 'Unlimited routes + multi-stop route planning',
  premFeatSaves: 'Unlimited saved routes',
  premFeatBoat: 'Boat profile and bay-fit check',
  premYearly: 'Yearly',
  premMonthly: 'Monthly',
  premYearlyTag: 'Best value',
  premPerMonthFmt: 'About {0} per month',
  premBuy: 'Go Premium',
  premRestore: 'Restore purchases',
  premRestoreDone: 'Store checked — no new active subscription found on this Apple account.',
  premActive: 'Premium active',
  premUntilFmt: 'Renews/ends: {0}',
  premNeedAccount: 'Premium is tied to your Koybul account, so it follows you across devices. Create a free account or sign in first.',
  premSignInBtn: 'Sign in / create account',
  premWebMsg: 'Premium subscriptions start in the Koybul iOS app; the web version has no purchases. Once subscribed, it works everywhere you sign in.',
  premUnavailable: 'The store can\'t be reached right now. Check your connection and try again later.',
  premPurchaseError: 'The purchase didn\'t complete. If you weren\'t charged, try again; if the problem persists, check your App Store account.',
  premLinking: 'Verifying your subscription…',
  premDone: 'Premium is active — fair winds, captain!',
  premCancelNote: 'The subscription renews automatically each period; cancel anytime with one tap in your App Store account. Your saved data is never deleted, even if Premium ends.',
  detPhotoBadgeFmt: '1/{0} · rest in Premium',
  detLockTitle: 'Full bay details are in Premium',
  detLockBody: 'Photos, occupancy, approach notes, hourly wind, contact and captains\' notes — all with Koybul Premium.',
  detLockCta: 'Discover Premium',
  detUnlockFmt: 'Open with an explore credit ({0} left)',
  detUnlockedFmt: 'Bay unlocked — {0} explore credits left this month.',
  detUnlockNone: 'This month\'s explore credits are used up — 3 more next month. Premium opens everything.',
  detLockSignIn: 'Join free — open 3 bays every month',
  rqTitle: 'Today\'s routes are used up (3/3)',
  rqBody: 'The free plan draws 3 new routes per day. The counter resets at midnight — 3 fresh routes tomorrow.',
  rqSavedNote: 'Opening saved routes and editing the current route never uses a credit.',
  rqPremiumBtn: 'Unlimited routes — see Premium',
  rqWaitBtn: 'I\'ll wait for tomorrow',
  rqUsedFmt: 'Route {0}/{1} used today',
  msTitle: 'Multi-stop routes are Premium',
  msBody: 'Free routes have a single destination. Chaining several bays into one voyage (A→B→C) opens with Koybul Premium. Your current route stays as it is.',
  rsSlotsTitle: 'Your route slots are full (3/3)',
  rsSlotsBody: 'The free plan stores 3 saved routes. Delete one to make room, or go Premium for unlimited saves.',
  ...
  seaRouteFrom: 'From your position · straight line',
  hourUnit: 'h',
  minUnit: 'min',
  ...
  srcRow: 'Sources & licenses',
  srcTitle: 'Sources & Licenses',
  srcLead: 'The map, weather and photo content in this app comes from the sources below. All attributions are collected here in one place; the list is readable offline too.',
  srcMapTitle: 'Map',
  srcMapBody: 'Basemap: Powered by Esri. Sea marks: OpenSeaMap. Map data: © OpenStreetMap contributors. The attribution is also always visible in the map corner.',
  srcWeatherTitle: 'Weather',
  srcWeatherBody: 'Wind and weather data are MET Norway (met.no) forecasts; the attribution and time are also shown on every forecast card. Forecasts are not a navigational broadcast.',
  srcDataTitle: 'Bay and harbor information',
  srcDataBody: 'Every record\'s description is stored together with its source quote and shown on the detail page; guessed or invented information is never entered. Göcek mooring occupancy and some photos come from DERİA (the Turkish Environment Agency).',
  srcPhotosTitle: 'Photos',
  srcPhotosLeadFmt: 'Attribution list for the {0} cover photos in the app. Tapping a row opens the photo\'s source page; the attribution is also shown on the photo itself.',
  ...
  routePlanFromMeSub: 'Pick a destination — the route starts from your shared location.',
  routePlanTwoPoints: 'Between two points (A → B)',
  routePlanTwoPointsSub: 'Pick the destination, then mark the start on the map or a cove. No location needed.',
  ...
  routeAddToSaved: 'Add to My Routes',
  routeMoreTooltip: 'More options',
  routeSaved: 'Added to My Routes — Deck → My Routes.',
...
const L10n _es = L10n(
  ...
  tripPlanBtn: 'Planificar travesía',
  tripPlannedShort: 'Añadida al diario ✓',
  tripPlannedSnack: 'Travesía añadida al diario como PLANIFICADA: márcala como Realizada cuando la hagas.',
  tripPlannedBadge: 'PLANIFICADA',
  tripMarkDone: 'Realizada ✓',
  tripDoneSheetTitle: 'Registrar la travesía',
  dateToday: 'Hoy',
  dateYesterday: 'Ayer',
  datePickLabel: 'Elegir fecha',
  tripDurQ: '¿Cuánto tiempo estuviste en el mar? (opcional)',
  dur2h: '~2 h',
  durHalf: 'Medio día',
  durFull: 'Día completo',
  tripNoteHint: 'Añade una nota… (opcional, va al Diario del capitán)',
  tripDoneSave: 'Registrar',
  tripDoneSnack: 'Travesía registrada como REALIZADA.',
  tripsEmpty: 'Aún no hay travesías. Traza una ruta en el mapa y toca "Planificar travesía": el plan aparece aquí; márcala como Realizada cuando la hagas.',
  ...
  todayWindCap: 'VIENTO',
  routeDistCap: 'DISTANCIA',
  routeEtaCap: 'TIEMPO',
  routeOriginSnapped: 'Inicio movido a la costa — tu ubicación estaba en tierra',
  ...
  admRow: 'Panel de administración',
  admTitle: 'Panel de administración',
  admLead: 'Las cifras llegan en vivo del servidor; solo las cuentas admin pueden verlo.',
  admUsers: 'Usuarios registrados',
  admGuests: 'Sesiones de invitado',
  admNew7d: 'Altas nuevas (7 días)',
  admPremium: 'Premium activos',
  admPending: 'Pendientes de aprobar',
  admReviews: 'Reseñas totales',
  admNotes: 'Notas de capitán',
  admGrantTitle: 'Conceder Premium',
  admGrantHint: 'Escribe el email de un usuario registrado y elige la duración: la cuenta pasa a Premium al instante.',
  admEmailLabel: 'Email del usuario',
  admMonthsFmt: '{0} meses',
  admGrantBtn: 'Conceder Premium',
  ...
  premRow: 'Koybul Premium',
  premTitle: 'Koybul Premium',
  premLead: 'Toda la información de las calas, rutas ilimitadas y más — una sola suscripción que navega contigo.',
  premFeatDetail: 'Información completa de las calas: fotos, ocupación, notas de aproximación, viento por horas',
  premFeatRoutes: 'Rutas ilimitadas + rutas con varias paradas',
  premFeatSaves: 'Guardado ilimitado de rutas',
  premFeatBoat: 'Perfil del barco y comprobación de compatibilidad con la cala',
  premYearly: 'Anual',
  premMonthly: 'Mensual',
  premYearlyTag: 'Mejor opción',
  premPerMonthFmt: 'Equivale a unos {0} al mes',
  premBuy: 'Pasar a Premium',
  premRestore: 'Restaurar compras',
  premRestoreDone: 'Tienda comprobada — no se encontró ninguna suscripción activa nueva en esta cuenta de Apple.',
  premActive: 'Premium activo',
  premUntilFmt: 'Renovación/fin: {0}',
  premNeedAccount: 'Premium se vincula a tu cuenta de Koybul, así te acompaña aunque cambies de dispositivo. Crea una cuenta gratuita o inicia sesión primero.',
  premSignInBtn: 'Iniciar sesión / crear cuenta',
  premWebMsg: 'La suscripción Premium se inicia en la app de Koybul para iOS; la versión web no tiene compras. Una vez suscrito, funciona dondequiera que inicies sesión.',
  premUnavailable: 'No se puede acceder a la tienda ahora mismo. Comprueba tu conexión e inténtalo más tarde.',
  premPurchaseError: 'La compra no se completó. Si no se te cobró, inténtalo de nuevo; si el problema continúa, revisa tu cuenta del App Store.',
  premLinking: 'Verificando tu suscripción…',
  premDone: '¡Premium activado — buen viento, capitán!',
  premCancelNote: 'La suscripción se renueva automáticamente cada período; cancélala cuando quieras desde tu cuenta del App Store. Tus datos guardados nunca se borran, aunque Premium termine.',
  detPhotoBadgeFmt: '1/{0} · el resto en Premium',
  detLockTitle: 'Todos los detalles de la cala están en Premium',
  detLockBody: 'Fotos, ocupación, notas de aproximación, viento por horas, contacto y notas de capitanes — todo con Koybul Premium.',
  detLockCta: 'Descubre Premium',
  detUnlockFmt: 'Abrir con un crédito de exploración (quedan {0})',
  detUnlockedFmt: 'Cala abierta — te quedan {0} créditos este mes.',
  detUnlockNone: 'Se acabaron los créditos de este mes — 3 más el mes que viene. Premium lo abre todo.',
  detLockSignIn: 'Únete gratis — abre 3 calas cada mes',
  rqTitle: 'Las rutas de hoy se agotaron (3/3)',
  rqBody: 'El plan gratuito traza 3 rutas nuevas al día. El contador se reinicia a medianoche — mañana tendrás 3 más.',
  rqSavedNote: 'Abrir rutas guardadas y editar la ruta actual nunca consume un crédito.',
  rqPremiumBtn: 'Rutas ilimitadas — conoce Premium',
  rqWaitBtn: 'Espero a mañana',
  rqUsedFmt: 'Ruta {0}/{1} usada hoy',
  msTitle: 'Las rutas multiparada son Premium',
  msBody: 'Las rutas gratuitas tienen un solo destino. Encadenar varias calas en una travesía (A→B→C) se abre con Koybul Premium. Tu ruta actual queda tal cual.',
  rsSlotsTitle: 'Tus ranuras de guardado están llenas (3/3)',
  rsSlotsBody: 'El plan gratuito guarda 3 rutas. Borra una para hacer sitio o pasa a Premium para guardado ilimitado.',
  ...
  seaRouteFrom: 'Desde tu posición · línea recta',
  hourUnit: 'h',
  minUnit: 'min',
  ...
  srcRow: 'Fuentes y licencias',
  srcTitle: 'Fuentes y licencias',
  srcLead: 'El contenido de mapas, meteorología y fotos de esta aplicación proviene de las fuentes siguientes. Todas las atribuciones se reúnen aquí; la lista también se puede leer sin conexión.',
  srcMapTitle: 'Mapa',
  srcMapBody: 'Mapa base: Powered by Esri. Señales marítimas: OpenSeaMap. Datos del mapa: © colaboradores de OpenStreetMap. La atribución también es siempre visible en la esquina del mapa.',
  srcWeatherTitle: 'Meteorología',
  srcWeatherBody: 'Los datos de viento y tiempo son pronósticos de MET Norway (met.no); la atribución y la hora también se muestran en cada tarjeta de pronóstico. Los pronósticos no son un boletín de navegación.',
  srcDataTitle: 'Información de calas y puertos',
  srcDataBody: 'La descripción de cada registro se guarda junto con su cita de origen y se muestra en la página de detalle; nunca se introduce información inventada. La ocupación de boyas de Göcek y algunas fotos provienen de DERİA (Agencia de Medio Ambiente de Turquía).',
  srcPhotosTitle: 'Fotos',
  srcPhotosLeadFmt: 'Lista de atribuciones de las {0} fotos de portada de la aplicación. Al tocar una fila se abre la página de origen de la foto; la atribución también se muestra sobre la foto.',
  ...
  routePlanFromMeSub: 'Elige el destino: la ruta parte de tu ubicación compartida.',
  routePlanTwoPoints: 'Entre dos puntos (A → B)',
  routePlanTwoPointsSub: 'Elige el destino y marca el inicio en el mapa o una cala. No requiere ubicación.',
  ...
  routeAddToSaved: 'Añadir a Mis rutas',
  routeMoreTooltip: 'Más opciones',
  routeSaved: 'Añadida a Mis rutas: Diario → Mis rutas.',
...
const L10n _ru = L10n(
  ...
  deckTabTrips: 'Походы',
  tripPlanBtn: 'Запланировать поход',
  tripPlannedShort: 'Добавлено в журнал ✓',
  tripPlannedSnack: 'Поход добавлен в журнал как ЗАПЛАНИРОВАН — отметьте «Состоялся», когда сходите.',
  tripPlannedBadge: 'ЗАПЛАНИРОВАН',
  tripMarkDone: 'Состоялся ✓',
  tripDoneSheetTitle: 'Записать поход в журнал',
  dateToday: 'Сегодня',
  dateYesterday: 'Вчера',
  datePickLabel: 'Выбрать дату',
  tripDurQ: 'Сколько времени вы были в море? (необязательно)',
  dur2h: '~2 ч',
  durHalf: 'Полдня',
  durFull: 'Весь день',
  tripNoteHint: 'Добавьте заметку… (необязательно, попадёт в журнал капитана)',
  tripDoneSave: 'Записать',
  tripDoneSnack: 'Поход записан как СОСТОЯЛСЯ.',
  tripsEmpty: 'Походов пока нет. Проложите маршрут на карте и нажмите «Запланировать поход» — план появится здесь; отметьте «Состоялся», когда сходите.',
  ...
  todayWindCap: 'ВЕТЕР',
  routeDistCap: 'ДИСТАНЦИЯ',
  routeEtaCap: 'ВРЕМЯ',
  routeOriginSnapped: 'Старт перенесён к берегу — вы находились на суше',
  ...
  admRow: 'Панель управления',
  admTitle: 'Панель управления',
  admLead: 'Цифры приходят с сервера; панель видят только администраторы.',
  admUsers: 'Зарегистрированные',
  admGuests: 'Гостевые сессии',
  admNew7d: 'Новые за 7 дней',
  admPremium: 'Активный Premium',
  admPending: 'Ожидают одобрения',
  admReviews: 'Всего отзывов',
  admNotes: 'Заметки капитанов',
  admGrantTitle: 'Выдать Premium',
  admGrantHint: 'Введите email зарегистрированного пользователя и выберите срок — аккаунт сразу станет Premium.',
  admEmailLabel: 'Email пользователя',
  admMonthsFmt: '{0} мес.',
  admGrantBtn: 'Выдать Premium',
  ...
  premRow: 'Koybul Premium',
  premTitle: 'Koybul Premium',
  premLead: 'Вся информация о бухтах, безлимитные маршруты и не только — одна подписка, которая ходит в море с вами.',
  premFeatDetail: 'Полные данные бухт: фото, занятость, заметки о подходе, ветер по часам',
  premFeatRoutes: 'Безлимитные маршруты + маршруты с несколькими остановками',
  premFeatSaves: 'Безлимитное сохранение маршрутов',
  premFeatBoat: 'Профиль лодки и проверка совместимости с бухтой',
  premYearly: 'Год',
  premMonthly: 'Месяц',
  premYearlyTag: 'Выгодный выбор',
  premPerMonthFmt: 'Примерно {0} в месяц',
  premBuy: 'Перейти на Premium',
  premRestore: 'Восстановить покупки',
  premRestoreDone: 'Магазин проверен — новой активной подписки на этом Apple-аккаунте не найдено.',
  premActive: 'Premium активен',
  premUntilFmt: 'Продление/окончание: {0}',
  premNeedAccount: 'Premium привязывается к аккаунту Koybul — подписка останется с вами на любом устройстве. Сначала создайте бесплатный аккаунт или войдите.',
  premSignInBtn: 'Войти / создать аккаунт',
  premWebMsg: 'Подписка Premium оформляется в приложении Koybul для iOS; в веб-версии покупок нет. После оформления она действует везде, где вы вошли в аккаунт.',
  premUnavailable: 'Магазин сейчас недоступен. Проверьте соединение и попробуйте позже.',
  premPurchaseError: 'Покупка не завершилась. Если деньги не списаны — попробуйте ещё раз; если проблема повторяется, проверьте аккаунт App Store.',
  premLinking: 'Проверяем вашу подписку…',
  premDone: 'Premium активирован — попутного ветра, капитан!',
  premCancelNote: 'Подписка продлевается автоматически; отменить её можно в любой момент в аккаунте App Store. Ваши сохранённые данные не удаляются, даже если Premium закончится.',
  detPhotoBadgeFmt: '1/{0} · остальное в Premium',
  detLockTitle: 'Все данные бухты — в Premium',
  detLockBody: 'Фото, занятость, заметки о подходе, ветер по часам, контакты и заметки капитанов — всё с Koybul Premium.',
  detLockCta: 'Узнать о Premium',
  detUnlockFmt: 'Открыть за кредит исследования (осталось {0})',
  detUnlockedFmt: 'Бухта открыта — в этом месяце осталось {0} кредитов.',
  detUnlockNone: 'Кредиты этого месяца закончились — в следующем будет 3 новых. Premium открывает всё.',
  detLockSignIn: 'Присоединяйтесь бесплатно — 3 бухты каждый месяц',
  rqTitle: 'Маршруты на сегодня закончились (3/3)',
  rqBody: 'Бесплатный план строит 3 новых маршрута в день. Счётчик обнуляется в полночь — завтра снова 3.',
  rqSavedNote: 'Открытие сохранённых маршрутов и правка текущего не тратят лимит.',
  rqPremiumBtn: 'Безлимитные маршруты — о Premium',
  rqWaitBtn: 'Подожду до завтра',
  rqUsedFmt: 'Сегодня использовано {0}/{1} маршрутов',
  msTitle: 'Маршруты с несколькими остановками — в Premium',
  msBody: 'В бесплатном маршруте одна точка назначения. Объединить несколько бухт в один переход (A→B→C) можно с Koybul Premium. Текущий маршрут остаётся как есть.',
  rsSlotsTitle: 'Слоты сохранения заполнены (3/3)',
  rsSlotsBody: 'Бесплатный план хранит 3 маршрута. Удалите один или перейдите на Premium для безлимита.',
  ...
  seaRouteFrom: 'От вашего местоположения · по прямой',
  hourUnit: 'ч',
  minUnit: 'мин',
  ...
  srcRow: 'Источники и лицензии',
  srcTitle: 'Источники и лицензии',
  srcLead: 'Карты, погода и фотографии в приложении взяты из источников ниже. Все указания авторства собраны здесь в одном месте; список доступен и без интернета.',
  srcMapTitle: 'Карта',
  srcMapBody: 'Картографическая основа: Powered by Esri. Морские знаки: OpenSeaMap. Данные карты: © участники OpenStreetMap. Атрибуция также всегда видна в углу карты.',
  srcWeatherTitle: 'Погода',
  srcWeatherBody: 'Данные о ветре и погоде — прогнозы MET Norway (met.no); атрибуция и время также показываются на каждой карточке прогноза. Прогнозы не являются навигационным изданием.',
  srcDataTitle: 'Сведения о бухтах и гаванях',
  srcDataBody: 'Описание каждой записи хранится вместе с цитатой источника и показывается на странице объекта; выдуманные данные не вводятся. Занятость буев в Гёджеке и часть фотографий — из DERİA (Агентство окружающей среды Турции).',
  srcPhotosTitle: 'Фотографии',
  srcPhotosLeadFmt: 'Список атрибуций для {0} обложек в приложении. Нажатие на строку открывает страницу источника фотографии; атрибуция также видна на самой фотографии.',
  ...
  routePlanFromMeSub: 'Выберите бухту — маршрут строится от вашей позиции.',
  routePlanTwoPoints: 'Между двумя точками (A → B)',
  routePlanTwoPointsSub: 'Выберите цель, затем отметьте старт на карте или в бухте. GPS не нужен.',
  ...
  routeAddToSaved: 'В «Мои маршруты»',
  routeMoreTooltip: 'Ещё',
  routeSaved: 'Добавлено в «Мои маршруты» — Журнал → Мои маршруты.',
