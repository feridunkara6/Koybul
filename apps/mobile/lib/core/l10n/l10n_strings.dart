...
const L10n _tr = L10n(
  ...
  tourBodies: <String>[
    ...
    'Favori yerlerin ve kayıtlı rotaların tek yerde. Yukarıda örnek bir rota kartı var: böyle bir karta dokununca rota haritada anında yeniden kurulur.',
    'Seyir notların burada. Yukarıdaki örnek nota bak: rota bilgisi kendiliğinden eklenir. Rota kaydettiğinde tek dokunuşla not düşebilirsin.',
...
const L10n _en = L10n(
  ...
  tourBodies: <String>[
    ...
    'Your favorite places and saved routes in one place. Above is a sample route card: tapping a card like this rebuilds the route on the map instantly.',
    'Your sailing notes live here. Look at the sample entry above: route details are attached automatically. One tap adds a note when you save a route.',
...
const L10n _es = L10n(
  ...
  tourBodies: <String>[
    ...
    'Tus lugares favoritos y rutas guardadas en un solo sitio. Arriba hay una tarjeta de ruta de ejemplo: al tocar una tarjeta así, la ruta se reconstruye al instante en el mapa.',
    'Tus notas de navegación viven aquí. Mira la nota de ejemplo de arriba: los datos de la ruta se añaden solos. Al guardar una ruta, un toque añade la nota.',
...
const L10n _ru = L10n(
  ...
  tourBodies: <String>[
    ...
    'Избранные места и сохранённые маршруты в одном месте. Выше — пример карточки маршрута: касание такой карточки мгновенно строит маршрут на карте.',
    'Здесь ваши заметки о походах. Взгляните на пример выше: данные маршрута добавляются сами. При сохранении маршрута заметка создаётся в одно касание.',
